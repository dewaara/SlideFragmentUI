package com.seven.bcofferapp.adapter;
...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        CustomItem item = (CustomItem) getItem(position);
        ImageView dropDownIV = convertView.findViewById(R.id.ivSpinnerLayout);
        TextView dropDownTV = convertView.findViewById(R.id.tvSpinnerLayout);
